  ...
  return (
    <section id="home" className="hero reveal">
        <div>
            ...
            <p>Software Engineer with 2+ years of experience across Software Houses, Healthcare, IT Consulting, and 
                Infrastructure sectors, specializing in building scalable, secure, and user-focused web applications. 
                Proficient in backend development using <strong>PHP (Native, Laravel, CodeIgniter)</strong> alongside <strong>MySQL, PostgreSQL, 
                and SQL Server 2008 R2</strong>, with a strong focus on system scalability, database optimization, and robust 
                security architectures. Currently expanding expertise into the Next.js and Node.js ecosystem to deliver 
                modern fullstack solutions and AI integrations as needed, I am passionate about transforming complex 
                business requirements into efficient digital products that solve real world challenges and drive measurable 
                business value.
            </p>
