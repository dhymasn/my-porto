      ...
      <div className="experience-grid">
        <div className="experience-card">
          ...
          <p className="experience-description">
            ...
            <br/>• Provided technical support and developed the Simpro (System Management Project) module, an integrated system to manage cross-division activities, improving &nbsp;&nbsp;operational efficiency, transparency, and document control.
            <br/>• Developed and maintained an internal budget management system to support submission, approval, and real-time monitoring of operational budgets between branch &nbsp;&nbsp;offices and headquarters.
        ...
        <div className="experience-card">
          ...
          <p className="experience-description">
            • Built and optimized SmartERP, including an online print queue system and a web based WhatsApp Gateway.
